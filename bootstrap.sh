...
docker cp pinot/debezium-table-definition.json debezium-pinot-example_pinot_1:/opt/pinot
docker cp pinot/debezium-schema-definition.json debezium-pinot-example_pinot_1:/opt/pinot
docker exec -ti debezium-pinot-example_pinot_1 bash -c "/opt/pinot/bin/pinot-admin.sh AddTable -tableConfigFile /opt/pinot/debezium-table-definition.json -schemaFile /opt/pinot/debezium-schema-definition.json -exec"
